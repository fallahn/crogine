...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new cro::String from a UTF-8 encoded string
    ///
    /// \param begin Forward iterator to the beginning of the UTF-8 sequence
    /// \param end   Forward iterator to the end of the UTF-8 sequence
    ///
    /// \return A cro::String containing the source string
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new cro::String from a UTF-16 encoded string
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    String substr(std::size_t position, std::size_t length = InvalidPos) const;
...
///
////////////////////////////////////////////////////////////
CRO_EXPORT_API bool operator ==(const String& left, const String& right);
...
///
////////////////////////////////////////////////////////////
CRO_EXPORT_API String operator +(const String& left, const String& right);

#include <crogine/core/String.inl>
...
/// \class cro::String
///
/// cro::String is a utility string class defined mainly for
...
/// cro::String s;
/// ...
/// cro::string s1 = s.toAnsiString(locale);
/// s = cro::String("hello", locale);
/// \endcode
///
/// cro::String defines the most important functions of the
/// standard std::string class: removing, random access, iterating,
/// appending, comparing, etc. However it is a simple class
/// provided for convenience, and you may have to consider using
/// a more optimized class if your program requires complex string
/// handling. The automatic conversion functions will then take
/// care of converting your string to cro::String whenever crogine
/// requires it.
///
/// Please note that SFML also defines a low-level, generic
/// interface for Unicode handling, see the cro::Utf classes.
///
////////////////////////////////////////////////////////////
