...
//TODO once this is battle hardened swap to using
//the std typedefs u8string /u16string etc
using UInt8 = char8_t;
...
///
/// cro::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li cro::Utf<8> (typedef'd to cro::Utf8)
/// \li cro::Utf<16> (typedef'd to cro::Utf16)
/// \li cro::Utf<32> (typedef'd to cro::Utf32)
///
////////////////////////////////////////////////////////////
