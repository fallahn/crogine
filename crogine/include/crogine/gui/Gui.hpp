...
namespace ImGui
{
    ...
    static inline bool ImageButton(const char* id, const cro::Texture& texture, const ImVec2& size, const ImVec2& uv0 = { 0.f, 0.f }, const ImVec2& uv1 = { 1.f, 1.f })
    {
        return ImGui::ImageButton(id, ImTextureRef(texture.getGLHandle()), size, uv0, uv1);
    }
    ...
    //{
    //    assert(false);
    //    return false;// ImGui::ImageButton(texture, size, uv0, uv1);
    //}
