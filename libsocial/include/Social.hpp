...
//(migrated from SDL2 to SDL3 1222 -> 1230)
...
#endif
#else
static constexpr std::uint16_t CURRENT_VER = 1230;
#ifdef __APPLE__
static const std::string StringVer("1.23.0 (macOS beta)");
#else
static const std::string StringVer("1.23.0");
#endif
#endif
