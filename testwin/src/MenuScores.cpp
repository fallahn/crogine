...
void MainState::createScoreMenu()
{
    ...
    m_highScoreScene.addSystem<cro::SpriteRenderer>(mb);
    m_highScoreScene.addSystem<cro::TextRenderer>(mb);
    m_highScoreScene.addSystem<cro::SceneGraph>(mb);
    auto* uiSystem = &m_highScoreScene.addSystem<cro::UISystem>(mb);
    ...
    auto entity = m_highScoreScene.createEntity();
    ...
    auto textEnt = m_highScoreScene.createEntity();
    ...
    titleTextTx.setPosition({ 860.f, 800.f, 0.f });
    ...
    entity = m_highScoreScene.createEntity();
    ...
    textEnt = m_highScoreScene.createEntity();
