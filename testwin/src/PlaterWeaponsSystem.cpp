...
{
    //if active spawn more of current weapon
    if (m_systemActive)
    {

    }

    //update position of alive weapons
...
void PlayerWeaponSystem::handleMessage(const cro::Message& msg)
{
    ...
    //stop firing if released or player died
...
{
    //TODO add entity to dead list based on type
}