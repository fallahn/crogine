...
void VatsState::createScene()
{
    ...
    camEnt.getComponent<cro::Camera>().resizeCallback = std::bind(&VatsState::updateView, this, std::placeholders::_1);
}

void VatsState::createUI()
{

}

void VatsState::updateView(cro::Camera& cam3D)
{
