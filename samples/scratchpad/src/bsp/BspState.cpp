...
BspState::BspState(cro::StateStack& stack, cro::State::Context context)
...
//public
bool BspState::handleEvent(const cro::Event& evt)
{
...
void BspState::handleMessage(const cro::Message& msg)
{
    m_scene.forwardMessage(msg);
}

bool BspState::simulate(float dt)
{
...
void BspState::createScene()
{
    ...
    cam.resizeCallback = std::bind(&BspState::updateView, this, std::placeholders::_1);
...
void BspState::updateView(cro::Camera& cam3D)
{
