...
class PuttingState final : public cro::State, public cro::GuiClient
{
public:
    PuttingState(cro::StateStack&, cro::State::Context, SharedStateData&);

    cro::StateID getStateID() const override { return StateID::PuttingRange; }
