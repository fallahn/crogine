...
static constexpr std::array<ShotModifier, ClubID::Count> pA =
{
    ...
    ShotModifier(-0.358f, 1.312f, 1.007f),
    ShotModifier(-0.351f, 1.312f, 1.000f),
    ShotModifier(-0.343f, 1.312f, 0.999f),
    ShotModifier(-0.282f, 1.218f, 1.000f),
    ShotModifier(-0.290f, 1.231f, 1.000f),
    ShotModifier(-0.290f, 1.238f, 1.000f),
...
static constexpr std::array<ShotModifier, ClubID::Count> pB =
{
    ...
    ShotModifier(-0.267f, 1.170f, 1.000f),
    ShotModifier(-0.305f, 1.224f, 1.000f),
    ShotModifier(-0.275f, 1.203f, 1.000f),
    ShotModifier(-0.328f, 1.293f, 1.000f),
    ShotModifier(-0.290f, 1.231f, 1.000f),
    ShotModifier(-0.305f, 1.265f, 1.000f),
...
static constexpr std::array<ShotModifier, ClubID::Count> pC =
{
    ...
    ShotModifier(-0.298f, 1.210f, 1.000f),
    ShotModifier(-0.351f, 1.306f, 1.000f),
    ShotModifier(-0.343f, 1.312f, 1.000f),
    ShotModifier(-0.328f, 1.298f, 1.000f),
    ShotModifier(-0.336f, 1.312f, 1.000f),
    ShotModifier(-0.289f, 1.231f, 1.000f),
