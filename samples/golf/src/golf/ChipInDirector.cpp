...
ChipInDirector::ChipInDirector(std::vector<HoleData>& hd)
    : m_holeData	(hd),
    m_holeCount		(0),
    m_totalHoleCount(18),
    m_holeIndex     (-1)
...
//public
void ChipInDirector::handleMessage(const cro::Message& msg)
{
    switch (msg.id)
    {
    default: break;
...
void ChipInDirector::process(float)
{

}

void ChipInDirector::setHoleCount(std::int32_t count, std::int32_t holeIndex)
{
...
std::int32_t ChipInDirector::getCurrentHole() const
{
