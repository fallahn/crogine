...
void PuttingState::createGameOptions()
{
...
void PuttingState::createSummary()
{
    auto* uiSystem = m_uiScene.getSystem<cro::UISystem>();
...
void PuttingState::updateMinimap()
{
...
void PuttingState::updateWindDisplay(glm::vec3 direction)
{
...
void PuttingState::showMessage(float range)
{
...
void PuttingState::floatingMessage(const std::string& msg)
{
