...
namespace ul
{
    ...
    static inline const std::array<UnlockData, UnlockID::Count> Items =
    {
        ...
        { ModelID::Streak01,  "1 Day Streak",    "+10XP" },
        { ModelID::Streak02,  "2 Day Streak",    "+40XP" },
        { ModelID::Streak03,  "3 Day Streak",    "+90XP" },
        { ModelID::Streak04,  "4 Day Streak",    "+160XP" },
        { ModelID::Streak05,  "5 Day Streak",    "+250XP" },
        { ModelID::Streak06,  "6 Day Streak",    "+360XP" },
        { ModelID::Streak07,  "7 Day Streak",    "+500XP" },
