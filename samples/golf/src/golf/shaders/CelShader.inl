...
vec3 fragDir = v_worldPosition - v_cameraWorldPosition;
float fragDist = dot(fragDir, fragDir);
float fragDistAmt = 1.0 - ((clamp(fragDist / (20.0 * 20.0), 0.0, 1.0) * 0.15) * (1.0 - u_maskColour.b));
colour.rgb *= fragDistAmt;
