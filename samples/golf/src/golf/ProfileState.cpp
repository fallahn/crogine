...
void ProfileState::createItemPage(cro::Entity parent, std::int32_t page)
{
    ...
    auto& browserPage = m_ballPages.emplace_back();
    ...
    browserPage.activateCallback = m_uiScene.getSystem<cro::UISystem>()->addCallback(
