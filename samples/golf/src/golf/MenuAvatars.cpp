...
void MenuState::createAvatarMenu(cro::Entity parent)
{
    ...
    entity.getComponent<cro::UIInput>().setNextIndex(PlayerPrevProf, PlayerClubStats);
    ...
    if (Social::getClubLevel())
    {
        ...
        entity.getComponent<cro::UIInput>().setPrevIndex(PlayerEdit, PlayerClubStats);
        entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Selected] = selectionCallback;
        entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Unselected] = unselectionCallback;
        entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::ButtonUp] = uiSystem.addCallback(
            [&](cro::Entity e, const cro::ButtonEvent& evt)
        ...
        m_clubsetButtons.roster = buttonEnt;
    }
    ...
    //open shop
    entity = m_uiScene.createEntity();
    entity.addComponent<cro::Transform>().setPosition({ 275.f, 59.f, 0.1f });
    entity.addComponent<cro::AudioEmitter>() = m_menuSounds.getEmitter("switch");
    entity.addComponent<cro::Drawable2D>();
    ...
    entity.addComponent<cro::UIInput>().area = bounds;
    entity.getComponent<cro::UIInput>().setGroup(MenuID::Avatar);
    entity.getComponent<cro::UIInput>().setSelectionIndex(PlayerShop);
    entity.getComponent<cro::UIInput>().setNextIndex(PlayerEdit, PlayerCreate);
    entity.getComponent<cro::UIInput>().setPrevIndex(PlayerClubStats, PlayerRemove);
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Selected] = selectionCallback;
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Unselected] = unselectionCallback;
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::ButtonUp] = uiSystem.addCallback(
        [&](cro::Entity, const cro::ButtonEvent& evt)
    ...
    entity.getComponent<cro::UIInput>().setPrevIndex(PlayerReset, PlayerShop);
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Selected] = selectionCallback;
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Unselected] = unselectionCallback;
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::ButtonUp] = uiSystem.addCallback(
        [&](cro::Entity, const cro::ButtonEvent& evt)
    ...
    entity.getComponent<cro::UIInput>().setPrevIndex(PlayerClubs, PlayerCreate);
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Selected] = selectionCallback;
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::Unselected] = unselectionCallback;
    entity.getComponent<cro::UIInput>().callbacks[cro::UIInput::ButtonUp] = uiSystem.addCallback(
        [&](cro::Entity e, const cro::ButtonEvent& evt)
    ...
    entity.getComponent<cro::UIInput>().setPrevIndex(PlayerNextMenu, PlayerClubStats);
    ...
    entity.getComponent<cro::UIInput>().setPrevIndex(PlayerLeaveMenu, Social::getClubLevel() ? PlayerClubs : PlayerProfile);
    ...
    entity.getComponent<cro::UIInput>().setNextIndex(PlayerNextMenu, PlayerShop);
...
void MenuState::createProfileLayout(cro::Entity parent, cro::Transform& menuTransform, const cro::SpriteSheet& spriteSheet)
{
    ...
    labelEnt.addComponent<cro::Callback>().active = true;
    labelEnt.getComponent<cro::Callback>().function =
        [&, current, longest](cro::Entity e, float)
        {
...
#else
                e.getComponent<cro::Text>().setString(current + longest);
#endif
            }
        };
        ...
        for (const auto& c : m_sharedData.connectionData)
        {
            ...
            if (c.connectionID < m_sharedData.nameTextures.size())
            {
                ...
                for (auto i = 0u; i < c.playerCount; ++i)
                {
                    ...
                    simpleQuad.setPosition({ simpleText.getPosition().x - 2.f,(i * (textureSize.y / ConstVal::MaxPlayers)) - 1.f });
                    simpleQuad.setScale({ (bounds.width + 5.f), 16.f });
                    simpleQuad.draw();
                    simpleText.draw();
                }
