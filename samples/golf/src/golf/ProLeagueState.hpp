...
class ProLeagueState final : public cro::State
{
public:
    ProLeagueState(cro::StateStack&, cro::State::Context, SharedStateData&);
    ...
    cro::StateID getStateID() const override { return StateID::Career; }
