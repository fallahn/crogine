...
{
    //red balls
    static constexpr glm::vec3 Offset(0.f, BallHeight, 0.0935f - 0.465f); //distance to middle ball (TODO set this correctly)
    ...
    m_ballLayout.emplace_back(glm::vec3(0.3f, BallHeight, 0.f), 2); //0.2 * table length
    m_ballLayout.emplace_back(glm::vec3(0.f, BallHeight, 0.f), 3);
    m_ballLayout.emplace_back(glm::vec3(-0.3f, BallHeight, 0.f), 4);
    m_ballLayout.emplace_back(glm::vec3(0.f, BallHeight, 0.f), 5); //perfect centre
    m_ballLayout.emplace_back(glm::vec3(0.f, BallHeight, 0.f), 6); //0.25 table length
    m_ballLayout.emplace_back(glm::vec3(0.f, BallHeight, 0.f), 7); //0.09 table length
}
