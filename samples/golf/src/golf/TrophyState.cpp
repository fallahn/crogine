    ...
    m_viewScale         (2.f)
{
    ...
    m_scene.setTitle("Trophy UI");
    m_trophyScene.setTitle("Trophy Preview");
...
void TrophyState::buildTrophyScene()
{
    ...
    const std::array<std::string, 17u> paths =
    {
        ...
        "assets/golf/models/trophies/tourn01.cmt",
        "assets/golf/models/trophies/tourn02.cmt",
    };
