...
namespace
{
    ...
    struct MenuCallback final
    {
        ...
        std::int32_t menuID = ChipInState::MenuID::Dummy;
...
void ChipInState::createUI()
{
    ...
    entity.getComponent<cro::Callback>().function =
        ...
        {
            const float scale =
                (ClubShot[m_inputParser.getClub()] & ShotType::Punch) ? 1.f : 0.f;
            e.getComponent<cro::Transform>().setScale(glm::vec2(scale));
        };
    spinEnt.getComponent<cro::Transform>().addChild(entity.getComponent<cro::Transform>());
    ...
    entity.getComponent<cro::Callback>().function =
        ...
        {
            const float scale =
                (ClubShot[m_inputParser.getClub()] & ShotType::Flop) ? 1.f : 0.f;
            e.getComponent<cro::Transform>().setScale(glm::vec2(scale));
        };
    spinEnt.getComponent<cro::Transform>().addChild(entity.getComponent<cro::Transform>());
...
void ChipInState::createPowerBars(cro::Entity rootNode)
{
...
void ChipInState::createGameOptions()
{
...
void ChipInState::updateWindDisplay(glm::vec3 direction)
{
...
void ChipInState::floatingMessage(const std::string& msg)
{
...
void ChipInState::updateSkipMessage(float dt)
{
