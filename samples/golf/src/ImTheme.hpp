static inline void SetupImGuiStyle()
{
    ...
    style.WindowTitleAlign = ImVec2(0.5f, 0.2000000029802322f);
    style.WindowMenuButtonPosition = ImGuiDir_Left;
    style.ChildRounding = 0.0f;
    style.ChildBorderSize = 1.0f;
    style.PopupRounding = 5.199999809265137f;
    ...
    style.GrabRounding = 3.799999952316284f;
    style.TabRounding = 4.0f;
    style.TabBorderSize = 0.0f;
    style.TabMinWidthForCloseButton = 0.0f;
    style.ColorButtonPosition = ImGuiDir_Right;
    style.ButtonTextAlign = ImVec2(0.6000000238418579f, 0.5f);
    ...
    style.Colors[ImGuiCol_WindowBg] = ImVec4(0.3137255012989044f, 0.1568627506494522f, 0.1843137294054031f, 1.0f);
